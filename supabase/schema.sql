...
-- ============================================================
-- VARIABLES TABLE
-- Metadata for all monitored civilizational variables
-- ============================================================
create table if not exists variables (
  id text primary key,            -- e.g. 'economy.gdp_growth'
  label text not null,
  unit text,
  description text,
  keywords text[],
...
create index variables_module_idx on variables(module);

-- ============================================================
-- Enable Row Level Security (open for now, restrict per user later)
-- ============================================================
alter table variables enable row level security;
create policy "Allow all" on variables for all using (true) with check (true);
