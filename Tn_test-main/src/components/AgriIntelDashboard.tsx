...
import { ModuleHeader, BackgroundGrid, CornerAccent, LiveTicker } from './ProfessionalShared';
                    ...
                    {chartData.map((d, i) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-[9px] font-mono text-white">{d.name.toUpperCase()}</span>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div className="glass rounded-xl border border-intel-border p-5 space-y-4 overflow-hidden">
                  ...
                  <div className="h-[280px] overflow-y-auto pr-1 space-y-2">
                    {cropYieldByGov.map(gov => (
                      <div key={gov.gov} className="p-2 rounded-lg bg-white/5 border border-white/5">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div className="glass rounded-xl border border-intel-border p-5 space-y-4 overflow-hidden">
                  ...
                  <div className="space-y-2 overflow-y-auto max-h-[220px] pr-1">
                    {cropCalendar.map(c => (
                      <div key={c.crop} className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5">
                        <div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={foodImportDependency} layout="vertical">
                        ...
                        <Bar dataKey="dependency" radius={[0, 4, 4, 0]} name="Dependency (%)">
                          {foodImportDependency.map((entry, index) => (
                            <Cell key={`cell-${index}`} fill={entry.dependency > 80 ? '#ef4444' : entry.dependency > 50 ? '#f97316' : '#00f2ff'} />
                          ))}
                        </Bar>
                      </BarChart>
                    </ResponsiveContainer>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                <div className="lg:col-span-1 glass rounded-xl border border-intel-border p-5 space-y-4">
                  ...
                  <div className="space-y-3">
                    {ruralUnrestIndex.map(r => (
                      <div key={r.gov} className="p-2 border-b border-white/5 hover:bg-white/[0.02] transition-all">
                        <div className="flex justify-between items-center mb-1">
                          <span className="text-[10px] font-bold text-white uppercase">{r.gov}</span>
