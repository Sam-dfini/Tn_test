...
import { BASE_FEED, computeFeedIndices } from './FeedIntelligenceHub';
            ...
            <div className="space-y-6">
              ...
              <div className="glass rounded-xl border border-intel-border p-5 space-y-4">
                ...
                <div className="space-y-2">
                  {eidGovRisk.map((g, i) => (
                    <div key={i} className={cn('p-3 rounded-xl border space-y-1.5',
            ...
            <div className="space-y-6">
              <div className="glass rounded-xl border border-intel-border p-5 space-y-4">
                ...
                <div className="space-y-3">
                  {supplyChainRisks.map((r, i) => (
                    <div key={i} className={cn('p-4 rounded-xl border space-y-2',
                  ...
                  <table className="w-full min-w-[500px]">
                    <thead>
                      <tr className="border-b border-white/10">
                        {['Region', 'Lamb/kg', 'Beef/kg', 'Official Lamb', 'BM Premium', 'Status'].map(h => (
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={regionalPrices}>
                      ...
                      <Bar dataKey="lamb_kg" radius={[4,4,0,0]} name="Lamb price">
                        {regionalPrices.map((e, i) => (
                          <Cell key={i} fill={e.lamb_kg > 41 ? '#ef4444' : e.lamb_kg > 38 ? '#f97316' : '#f59e0b'} />
                        ))}
                      </Bar>
                    </BarChart>
                  </ResponsiveContainer>
