            ...
            {alignment.alignedPairs.length > 0 && (
              <div className="space-y-1">
                ...
                {alignment.alignedPairs.map((p, i) => (
                  <div key={`${p}-${i}`} className="flex items-center space-x-2" title="These cycles are synchronized, leading to potential structural breakthroughs or crises.">
            ...
            {alignment.desyncPairs.length > 0 && (
              <div className="space-y-1">
                ...
                {alignment.desyncPairs.map((p, i) => (
                  <div key={`${p}-${i}`} className="flex items-center space-x-2" title="These cycles are out of phase, acting as a buffer that reduces overall systemic stress.">
