        ...
        <div className="space-y-6">
          <div className="bg-[#1e293b] border border-indigo-500/20 rounded-xl p-6">
            ...
            <div className="relative">
              <input 
                type="text" 
                placeholder="Search individuals, organizations, events..." 
                className="w-full bg-[#0f172a] border border-indigo-500/30 rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-indigo-400"
              />
              <Search className="absolute right-3 top-2.5 w-4 h-4 text-indigo-400/50" />
            </div>
          </div>
