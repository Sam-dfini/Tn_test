...
const DEFAULT_SOURCES: Source[] = [
  ...
  // ============================================================
  {
    ...
    type: 'rss',
    name: 'Nawaat',
    url: 'https://news.google.com/rss/search?q=site:nawaat.org&hl=fr&gl=TN&ceid=TN:fr',
    language: 'AR/FR',
    reliability: 'A',
  ...
  },
  {
    ...
    language: 'EN',
    reliability: 'A',
    notes: 'International news. Good for regional and diplomatic coverage.',
    status: 'untested',
    active: true,
  ...
  },
  {
    ...
    language: 'AR',
    reliability: 'A',
    notes: 'Fact-checking and news verification in Tunisia.',
    status: 'untested',
    active: true,
  ...
  },
  {
    ...
    language: 'FR/EN',
    reliability: 'B',
    notes: 'Economic and business news focus.',
    status: 'untested',
    active: true,
  ...
  },
  {
    ...
    language: 'FR',
    reliability: 'B',
    notes: 'Business and finance news.',
    status: 'untested',
    active: true,
  ...
  },
  {
    ...
    language: 'FR',
    reliability: 'A',
    notes: 'High-quality analysis and opinion.',
    status: 'untested',
    active: true,
  ...
  },
  {
    ...
    type: 'rss',
    name: 'Le Maghreb',
    url: 'https://news.google.com/rss/search?q=site:lemaghreb.tn&hl=ar&gl=TN&ceid=TN:ar',
    language: 'AR',
    reliability: 'B',
    notes: 'Major Arabic-language daily. Strong political and economic coverage.',
    status: 'untested',
    active: true,
    keywords: ['المغرب', 'تونس', 'سياسة', 'اقتصاد'],
    addedAt: '2026-04-13',
    builtIn: true,
  },
  {
    ...
    type: 'rss',
    name: 'Babnet',
    url: 'https://www.babnet.net/feed.php',
    language: 'AR/FR',
    reliability: 'B',
    notes: 'Popular news portal. High volume of social and political news.',
    status: 'untested',
    active: true,
    keywords: ['تونس', 'سياسة', 'مجتمع'],
    addedAt: '2026-04-13',
    builtIn: true,
  },
  {
    ...
    type: 'rss',
    name: 'TunisiaSat',
    url: 'https://news.google.com/rss/search?q=site:tunisia-sat.com&hl=ar&gl=TN&ceid=TN:ar',
    language: 'AR',
    reliability: 'C',
    notes: 'Largest Tunisian forum. Good for early signals and public sentiment.',
    status: 'untested',
    active: true,
    keywords: ['تونس', 'منتدى', 'أخبار'],
    addedAt: '2026-04-13',
    builtIn: true,
  },
  {
    ...
    type: 'rss',
    name: 'Ilboursa',
    url: 'https://news.google.com/rss/search?q=site:ilboursa.com&hl=fr&gl=TN&ceid=TN:fr',
    language: 'FR',
    reliability: 'B',
    notes: 'Leading financial and stock market news portal in Tunisia.',
    status: 'untested',
    active: true,
    keywords: ['Bourse', 'BVMT', 'économie', 'Tunisie', 'société'],
    addedAt: '2026-04-15',
    builtIn: true,
  },
  // ============================================================
...
const testConnection = async (source: Source): Promise<Partial<Source>> => {
  ...
  try {
    // Use proxy for RSS and API to avoid CORS
    const targetUrl = source.url.includes('?') ? `${source.url}&_cb=${Date.now()}` : `${source.url}?_cb=${Date.now()}`;
    const url = (source.type === 'rss' || source.type === 'api')
    ...
    const response = await Promise.race([
      fetch(url, {
        method: source.type === 'social' ? 'HEAD' : 'GET',
