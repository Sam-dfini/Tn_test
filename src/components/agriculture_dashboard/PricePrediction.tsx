      ...
      <div className="flex-1 p-4 flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col">
          <div className="flex gap-2 mb-4">
            <select className="bg-[#0a0f1a] border border-[#1e3a5f] text-xs px-2 py-1 rounded text-[#f1f5f9] outline-none">
              <option>Chicken</option>
              <option>Bread</option>
              <option>Vegetables</option>
            </select>
            <span className="text-xs text-[#94a3b8] flex items-center ml-auto">
              CURRENT: <span className="font-mono text-white text-lg font-bold ml-2">8.50 TND/kg</span>
            </span>
          </div>
