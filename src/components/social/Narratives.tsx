      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          {narratives.map((nar, i) => (
            <motion.div 
              key={generateStableKey(nar, i, 'nar')}
        ...
        <div className="intel-card p-8 rounded-2xl border border-intel-border flex flex-col space-y-8">
          ...
          <div className="flex-1 space-y-6">
            {analysisNotes.map((note, i) => (
              <div key={generateStableKey(note, i, 'note')} className={cn("p-5 rounded-2xl border space-y-3", 
            ...
            <div className="mt-auto pt-6 border-t border-intel-border flex items-center justify-between">
              <div className="flex -space-x-2">
                {[1, 2, 3].map(i => (
                  <div key={generateStableKey(null, i, 'user')} className="w-6 h-6 rounded-full bg-slate-800 border border-intel-bg flex items-center justify-center">
