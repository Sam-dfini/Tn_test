        ...
        <div className="lg:col-span-2 bg-slate-900/50 border border-white/10 rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={`comp-${comp.label}`} className="space-y-2">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-white/5">
              {miiProfile.ministryProfiles.map((profile) => (
                <tr key={`ministry-${profile.name}`} className="hover:bg-white/5 transition-colors group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-slate-900/50 border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-6 relative before:absolute before:left-2 before:top-2 before:bottom-2 before:w-px before:bg-white/10">
            {miiProfile.recentEvents.map((event) => (
              <div key={`event-${event.date}-${event.ministry}`} className="relative pl-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-900/50 border border-white/10 rounded-2xl p-6">
            ...
            <div className="space-y-3">
              {miiProfile.keySignals.map((signal) => (
                <div key={`signal-${signal}`} className="flex items-center gap-3 p-2 bg-white/5 rounded-lg border border-white/5">
