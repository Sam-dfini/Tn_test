      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 lg:col-span-4 glass p-8 rounded-2xl bg-gradient-to-br from-intel-card to-intel-orange/5">
          ...
          <div className="space-y-4">
            ...
            <button 
              onClick={() => window.dispatchEvent(new CustomEvent('navigate-main', { detail: { tab: 'propagation' } }))}
              className="w-full py-3 bg-intel-orange/10 text-intel-orange border border-intel-orange/20 rounded-xl text-[10px] font-mono uppercase font-bold hover:bg-intel-orange/20 transition-all"
            >
              Launch Simulator
            </button>
          </div>
