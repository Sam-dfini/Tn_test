...
const RiskBadge: React.FC<{ level: string }> = ({ level }) => {
  const map: Record<string, string> = {
    ...
    OK: 'text-slate-400 border-slate-500/30 bg-slate-500/10',
  };
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {prepareList([
                  ...
                  <div key={generateStableKey(k, i, 'import-kpi')} className={cn('glass rounded-xl border p-4 space-y-2', k.warn ? 'border-red-500/30 bg-red-500/5' : 'border-intel-border')}>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {prepareList([
                  ...
                  <div key={generateStableKey(k, i, 'fodder-kpi')} className="glass rounded-xl border border-red-500/30 bg-red-500/5 p-4 space-y-2">
                    <div className="text-[9px] font-mono text-slate-500 uppercase tracking-widest">{k.label}</div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {prepareList([
                  ...
                  <div key={generateStableKey(k, i, 'bm-kpi')} className="glass rounded-xl border border-red-500/30 bg-red-500/5 p-4 space-y-2">
                    <div className="text-[9px] font-mono text-slate-500 uppercase tracking-widest">{k.label}</div>
              ...
              <div className="glass rounded-xl border border-intel-border p-5 space-y-4">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full min-w-[600px]">
                    ...
                    <tbody className="divide-y divide-white/5">
                      {prepareList(blackMarketFeed).map((row: any, i: number) => {
              ...
              <div className="glass rounded-xl border border-intel-border overflow-hidden">
                ...
                <div className="divide-y divide-white/5">
                  {prepareList(blackMarketOsint).map((s: any, i: number) => (
                    <div key={generateStableKey(s, i, 'osint')} className="flex items-center gap-4 px-5 py-3 hover:bg-white/[0.02] transition-colors">
                ...
                <div className="flex items-start justify-between gap-6">
                  ...
                  <div className="hidden md:block space-y-2 text-right">
                    ...
                    {prepareList([
                      ...
                      <div key={generateStableKey(c, i, 'alert-cond')} className="flex items-center gap-2 justify-end">
                        {c.met
